...
if (isset($_POST['daftar'])) {
    if (tambahData($_POST) > 0) {
        ...
        "
		<script>
			alert('Data Fakultas gagal ditambahkan');
			document.location.href = './index.php';
		</script>
            ...
            <div class="col-lg-11">
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" autocomplete="off" autofocus name="fakultas" class="form-control" id="fakultas" required placeholder="Masukkan nama fakultas">

                    </div>
                    <div class="mb-3">
                        <label for="animo" class="form-label">Jumlah Animo : </label>
                        <input type="text" autocomplete="off" name="animo" class="form-control" id="animo" required placeholder="Masukkan jumlah animo">
                    </div>
